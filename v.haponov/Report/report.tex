...
Згідно розрахунків в таблиці Табл. ~\ref{tabl:IntensSens}, можна розрахувати кількість речовини, яка необхідна для детектування даною системою. Починаючи з мас наведених у Табл. ~\ref{tabl:mass}, піки елементів вдається відокремити від фону.
\begin{table}[h]
	\centering
