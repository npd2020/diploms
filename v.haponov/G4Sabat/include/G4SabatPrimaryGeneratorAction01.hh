...
// ********************************************************************
// $Id: G4SabatPrimaryGeneratorAction.hh $
//
/// \file G4SabatPrimaryGeneratorAction01.hh
/// \brief Definition of the G4SabatPrimaryGeneratorAction01 class
...
class G4SabatPrimaryGeneratorAction01 : public G4VUserPrimaryGeneratorAction
{
public:
    G4SabatPrimaryGeneratorAction01();
    virtual ~G4SabatPrimaryGeneratorAction01();
...
private:
    ...
    QList<G4ParticleGun*> listParticle = QList<G4ParticleGun*>();
