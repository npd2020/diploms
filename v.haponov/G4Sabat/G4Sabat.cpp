...
#include "G4SabatDetectorConstruction01.hh" // Структура детектора,
...
#include "G4SabatActionInitialization01.hh" // Пользовательский класс
...
int main(int argc, char** argv)
{
    ...
    runManager->SetUserInitialization(new G4SabatDetectorConstruction01);
    ...
    runManager->SetUserInitialization(new G4SabatActionInitialization01);
