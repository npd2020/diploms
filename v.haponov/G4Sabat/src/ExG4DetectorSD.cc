...
G4SabatDetectorSD::G4SabatDetectorSD(G4String name)
...
G4bool G4SabatDetectorSD::ProcessHits(G4Step* step, G4TouchableHistory* history)
{
...
G4SabatDetectorSD::~G4SabatDetectorSD()
{
